namespace ExtensionMain {
    ...
    class Configuration {
        ...
        static readonly Url = Configuration.IsProduction ? "https://odiom.net/UD--Server/" : "http://localhost/UD--Server/";
    }
    ...
    class Events {
        ...
        private static OnSendComment(e: CustomEvent): void {
            ...
            Events.SendCommentRequest.open("POST", Configuration.Url + "postcomment.php");
        ...
        private static OnSendCommentError(): void {
            let event = new CustomEvent("messageshow", {
                detail: {
                    title: "Fejl!",
                    message: "Kunne ikke sende kommentaren"
                }
            });
            document.documentElement.dispatchEvent(event);
        }
        ...
        private static OnDeleteComment(e: CustomEvent): void {
            ...
            Events.DeleteCommentRequest.open("POST", Configuration.Url + "deletecomment.php", true);
